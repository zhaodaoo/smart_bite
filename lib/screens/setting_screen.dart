...
class SettingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var getSerialStatusCards =
        context.select<SerialPortsProvider, List<SerialStatusCard>>((provider) {
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Column(
                    children: [
                      Text('Serial Ports Reading Time',
                      ...
                      Padding(
                        ...
                        child: Slider(
                          ...
                          min: 3,
                          divisions: 17,
                          label: serialPortsProvider.loadingTime
                              .round()
                              .toString(),
                  ...
                  Padding(
                    ...
                    child: FilledButton.icon(
                      onPressed: () async =>
                          await serialPortsProvider.updatePorts(),
                ...
                children: [
                  TextFormField(
                    ...
                    onFieldSubmitted: (value) {
                      ...
                      debugPrint(
                          'Printer Name = ${context.read<DataProvider>().printerName}');
                    },
                  ),
                  Text(
                      'Current Printer Name: ${context.select<DataProvider, String>((provider) => provider.printerName)}'),
                  Padding(
                    padding: const EdgeInsets.fromLTRB(0, 0, 0, 0),
                    child: FilledButton.icon(
                      onPressed: () async {
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: status == PortStatus.updating
